...
class LiveActivityManager {
  ...
  async start(): Promise<boolean> {
    ...
    if (!this.LiveActivitiesModule) {
      console.log('');
      console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
      console.log('🏝️  Live Activities 사용 안내');
      console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
      console.log('');
    ...
    try {
      ...
      console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
      console.log('');
      console.log('🏝️  Dynamic Island에서 자막 확인');
  ...
  async update(originalSubtitle: string, translatedSubtitle: string): Promise<void> {
    ...
    // 네이티브 모듈이 없으면 콘솔 로그만
    if (!this.LiveActivitiesModule) {
      console.log('🏝️ [Live Activity] 🇰🇷', originalSubtitle.substring(0, 30), '→ 🇺🇸', translatedSubtitle.substring(0, 30));
      return;
    }
